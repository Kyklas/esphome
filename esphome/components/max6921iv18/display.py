...
from esphome.const import CONF_ID, CONF_INTENSITY, CONF_DATA_PIN, CONF_CLOCK_PIN, CONF_ENABLE_PIN, CONF_LAMBDA

DEPENDENCIES = []

max6921iv18_ns = cg.esphome_ns.namespace('max6921iv18')
MAX6921IV18Component = max6921iv18_ns.class_('MAX6921IV18Component', cg.Component)
